...
const Header = ({ setIsOpen }) => {
  return (
    <div className="flex mt-5">
      <label htmlFor="search" className="flex items-center	 bg-slate-100 me-auto  px-4 rounded-3xl w-1/4	">
      ...
      <div className="flex items-center	">
        ...
        <div className="block lg:hidden px-4 cursor-pointer" onClick={() => setIsOpen((prev) => !prev)}>
          <FaBarsStaggered />
        </div>
      </div>
    </div>
